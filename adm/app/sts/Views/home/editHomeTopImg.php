    ...
    <div class="list-group-item">
        <div class="d-flex">
            <div class="mr-auto p-2">
                <h2 class="display-4 title">Editar a Imagem do Topo</h2>
            </div>
            <?php
            if (!empty($valorForm)) {
                extract($valorForm);
        ...
        <form id="edit_home_top_img" method="POST" action="" enctype="multipart/form-data">
            ...
            <?php
            if (isset($valorForm['image']) AND (!empty($valorForm['image'])) AND (file_exists('app/sts/assets/image/home_top/' . $valorForm['image']))) {
                $old_image = URLADM . 'app/sts/assets/image/home_top/' . $valorForm['image'];
            } else {
            ...
            <input name="EditHomeTopImg" type="submit" class="btn btn-outline-warning btn-sm" value="Salvar"> 
