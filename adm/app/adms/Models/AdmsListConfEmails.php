...
/**
 * A classe AdmsListConfEmails Recebe as informações das configurações de e-mails que serão listada na View
 *
 * @author Celke
 */
class AdmsListConfEmails 
{
    ...
    /** Metodo buscar as informações na tabela adms_confs_emails e fazer a paginação do resultado que será mostrado na View listar configurações de e-mail
     * 
