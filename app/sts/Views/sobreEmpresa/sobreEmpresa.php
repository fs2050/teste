...
//Ler o array de registro sobre empresa retornado do banco de dados
        foreach ($this->dados['sts_sobres_empresas'] as $sobre_emp) {
            ...
            extract($sobre_emp);
            if (isset($image) AND (!empty($image)) AND (file_exists('./adm/app/sts/assets/image/about_company/' . $id . '/' . $image))) {
            ...
            <div class="row featurette">
                ...
                <div class="col-md-5 order-md-1">
                    <img src="<?php echo $image; ?>" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" alt="><?php echo $title; ?>">
                </div>
            </div>
